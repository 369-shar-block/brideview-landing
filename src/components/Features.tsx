...
const features = [
  ...
  },
  {
    ...
    description: "Heart the looks you love from Round 1, and the AI builds Round 2 around exactly what you loved — same silhouette, same fabric, with fresh details to explore.",
