      ...
      <div className="relative max-w-3xl mx-auto px-6 text-center">
        ...
        >
          ...
          <h2 className="font-serif font-semibold" style={{ fontSize: "clamp(32px, 5vw, 56px)", lineHeight: 1.1, color: "#44403C", marginBottom: 20 }}>
            ...
            <span className="text-gold-gradient" style={{ fontStyle: "italic" }}>Bride</span>
          </h2>

          <p style={{ maxWidth: 440, margin: "0 auto 40px", fontSize: 18, color: "#78716C", lineHeight: 1.7, fontWeight: 300 }}>
            Stop scrolling. See dresses on you, and find the boutiques near you that <span style={{ color: "#44403C", fontWeight: 400 }}>carry them</span>.
          </p>
