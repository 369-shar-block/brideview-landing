          ...
          <section>
            ...
            <div className="grid sm:grid-cols-2" style={{ gap: 20 }}>
              {[
                ...
                { title: "Try Before You Pay", desc: "Start with a 3-day free trial. Membership is $39.99 every 3 months and includes 8 try-ons a month, with optional credit packs if you want more. Cancel anytime." },
